...
/***/ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./src/palette/css/style.scss":
/*!*******************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js??ref--7-2!./node_modules/sass-loader/dist/cjs.js??ref--7-3!./src/palette/css/style.scss ***!
  \*******************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var content = __webpack_require__(/*! !../../../node_modules/mini-css-extract-plugin/dist/loader.js!../../../node_modules/css-loader/dist/cjs.js??ref--7-2!../../../node_modules/sass-loader/dist/cjs.js??ref--7-3!./style.scss */ "./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js?!./node_modules/sass-loader/dist/cjs.js?!./src/palette/css/style.scss");
...
/***/ "./src/palette/js/API/GetBGImg.js":
/*!****************************************!*\
  !*** ./src/palette/js/API/GetBGImg.js ***!
  \****************************************/
/*! no static exports found */
...
exports.default = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var inpVal, url, redirectTo, response, data;
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        redirectTo = function redirectTo() {
                            var parameter1 = inpVal;
                            var parameter2 = '&client_id=6fa3cd1b61445e2e393b295ea7e207391c6b3098b8b258d31a95855d536b7807';
                            var urlImg = "https://api.unsplash.com/photos/random?query=town," + parameter1 + parameter2;
                            return urlImg;
                        };

                        inpVal = document.querySelector('.input_search__field').value;
                        url = redirectTo();
                        _context.next = 5;
                        return fetch(url);
...
exports.default = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var urlGeo, redirectToGeo, response1, dataLoc;
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        redirectToGeo = function redirectToGeo() {
                            var location = "https://ipinfo.io/json?token=b93e4ccc7c50fb";
                            console.log(location);
                            return location;
                        };

                        // получаем геолокацию и пихаем ее в функцию для получения урла картинки
                        urlGeo = redirectToGeo();
                        _context.next = 4;
                        return fetch(urlGeo);
...
/***/ "./src/palette/js/API/GetWether.js":
/*!*****************************************!*\
  !*** ./src/palette/js/API/GetWether.js ***!
  \*****************************************/
/*! no static exports found */
...
exports.default = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var inputValue, dataWeadher, urlWeadher, latitude, longitude, redirectTo, response;
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
                    case 0:
                        redirectTo = function redirectTo() {
                            var parameter1 = inputValue;
                            var parameter2 = '&lang=ru&units=metric&APPID=ce0d56825a4528e94c272e8f938bfcf9';
                            var urlWeadherAll = "https://api.openweathermap.org/data/2.5/forecast?q=" + parameter1 + parameter2;
                            return urlWeadherAll;
                        };

                        inputValue = document.querySelector('.input_search__field').value;
                        dataWeadher = void 0;
                        urlWeadher = void 0;
                        latitude = void 0;
                        longitude = void 0;
                    ...
                    case 12:
                        ...
                        return _context.abrupt('return', dataWeadher);
...
exports.default = function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(longitude, latitude) {
        var map;
        return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
                switch (_context.prev = _context.next) {
...
__webpack_require__(/*! ../css/style.scss */ "./src/palette/css/style.scss");

var _render = __webpack_require__(/*! ./render */ "./src/palette/js/render.js");

var _render2 = _interopRequireDefault(_render);

var _GetGeo = __webpack_require__(/*! ./API/GetGeo */ "./src/palette/js/API/GetGeo.js");

var _GetGeo2 = _interopRequireDefault(_GetGeo);

var _GetWether = __webpack_require__(/*! ./API/GetWether */ "./src/palette/js/API/GetWether.js");

var _GetWether2 = _interopRequireDefault(_GetWether);

var _GetBGImg = __webpack_require__(/*! ./API/GetBGImg */ "./src/palette/js/API/GetBGImg.js");

var _GetBGImg2 = _interopRequireDefault(_GetBGImg);

var _MapBox = __webpack_require__(/*! ./API/MapBox */ "./src/palette/js/API/MapBox.js");
...
// отрисовка страницы (из файла рендер)
(0, _render2.default)(); //получаем Геолокацию 

//получаем данные о погоде в зависимости от инпута value

//получаем ссылку на изображение в BG, пихаем ее в css 
...
(function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        ...
        var geoLock, weatherObj, getLinckIMG, mapBox, elemTime, elemDate, elemDayWeek, monthObjru, monthObjen, dayObjru, dayObjen, dayweek, getDate, compilDaysOfWeek, val, titleElem2, getIconWeather, titleElem5, titleElemCel, titleElemFar, valCel, valscle, valCel2, valCel3, valCel4, valscle2, valscle3, valscle4, chageGradusToFar, chageGradusToCel;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        chageGradusToCel = function chageGradusToCel() {
                        ...
                        chageGradusToFar = function chageGradusToFar() {
                            if (valscle.includes('C')) {
                                ...
                                var valFar2 = Math.round(valCel2 * 9 / 5 + 32);
                                ...
                                var valFar3 = Math.round(valCel3 * 9 / 5 + 32);
                                ...
                                var valFar4 = Math.round(valCel4 * 9 / 5 + 32);
                        ...
                        getIconWeather = function getIconWeather() {
                        ...
                        compilDaysOfWeek = function compilDaysOfWeek() {
                            var dayweek1 = dayweek + 1;
                            var dayweek2 = dayweek1 + 1;
                            var dayweek3 = dayweek2 + 1;
                            var dayWeekName1 = dayObjen[dayweek1];
                            var dayWeekName2 = dayObjen[dayweek2];
                            var dayWeekName3 = dayObjen[dayweek3];
                        ...
                        getDate = function getDate() // дата и время
                        {
                            var date = new Date();
                            ...
                            var monthName = monthObjen[month];
                            var dayWeekName = dayObjen[dayweek];
                        ...
                        _context2.next = 7;
                        return (0, _GetGeo2.default)();

                    case 7:
                        geoLock = _context2.sent;
                        _context2.next = 10;
                        return (0, _GetWether2.default)();

                    case 10:
                        weatherObj = _context2.sent;
                        _context2.next = 13;
                        return (0, _GetBGImg2.default)();

                    case 13:
                        getLinckIMG = _context2.sent;
                        _context2.next = 16;
                        return (0, _MapBox2.default)(weatherObj.city.coord.lat, weatherObj.city.coord.lon);

                    case 16:
                        mapBox = _context2.sent;
                        ...
                        elemDate = document.querySelector('.date');
                        elemDayWeek = document.querySelector('.day');
                        monthObjru = {
                            '0': 'Января',
                            '1': 'Февраля',
                            '2': 'Марта',
                        ...
                        val = void 0;
                        titleElem2 = document.querySelector('.button__search');

                        titleElem2.addEventListener('click', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
                            return regeneratorRuntime.wrap(function _callee$(_context) {
                                while (1) {
                                    switch (_context.prev = _context.next) {
                                        case 0:
                                            val = document.querySelector('.input_search__field').value;
                                            (0, _GetBGImg2.default)(); // листенер на кнопку поиска запуск функции получения ссылки на изображение BG
                                            _context.next = 4;
                                            return (0, _GetWether2.default)();

                                        case 4:
                                            weatherObj = _context.sent;
                                            // получаем данные о погоде для города введенного в инпут
                                            getIconWeather();
                        ...
                        titleElem5 = document.querySelector('.tools-bar_button__image');

                        titleElem5.addEventListener('click', function () {
                            (0, _GetBGImg2.default)();
                        });

                        // перевод Цельсий в фаренгейт
                        titleElemCel = document.querySelector('.degree_buttons__cel');
                        titleElemFar = document.querySelector('.degree_buttons__far');
                        valCel = void 0;
                        valscle = void 0;
                        valCel2 = void 0;
                        valCel3 = void 0;
                        ...
                        titleElemFar.addEventListener('click', function () {
                        ...
                        titleElemCel.addEventListener('click', function () {
                            valscle = document.querySelector('.scale_content').innerHTML;
                            chageGradusToCel();
                        });
                        ;
...
/***/ 0:
/*!*****************************************************!*\
  !*** multi babel-polyfill ./src/palette/js/main.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./src/palette/js/main.js */"./src/palette/js/main.js");
